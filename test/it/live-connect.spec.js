...
describe('LiveConnect', function () {
  ...
  // - Main page http://bln.test.liveintent.com:3001/page
  it('should send the referrer and the page url when the tracker is in the top window and there is no referrer', function () {
    const supportsLS = probeLS()
    server.openPage('bln.test.liveintent.com', 'page')
    sendEvent({}, supportsLS ? 1 : 2, server)
  ...
  // - Referrer http://schmoogle.com:3001/referrer?uri=http://bln.test.liveintent.com:3001/page
  // ---->
  // - Main page http://bln.test.liveintent.com:3001/page
  it('should send the referrer and the page url when the tracker is in the top window', function () {
    const supportsLS = probeLS()
    server.openUriViaReferrer('schmoogle.com', 'bln.test.liveintent.com', 'page')
    sendEvent({}, supportsLS ? 1 : 2, server)

    const firstTrackingRequest = server.getTrackingRequests()[0]
    expect('http://schmoogle.com:3001/referrer?uri=http://bln.test.liveintent.com:3001/page').to.eq(firstTrackingRequest.query.refr)
    expect('http://bln.test.liveintent.com:3001/page').to.eq(firstTrackingRequest.query.pu)
  })
  ...
  // - - Iframe1 http://bln.test.liveintent.com:3001/page
  it('should send the referrer and the page url when the tracker is in the iframe', function () {
    ...
    sendEventInIframe({}, supportsLS ? 1 : 2, server, 1)
  ...
  // - - - Iframe2 http://bln.test.liveintent.com:3001/page
  it('should send the referrer and the page url when the tracker is in the nested iframe', function () {
    ...
    sendEventInIframe({}, supportsLS ? 1 : 2, server, 2)
  ...
  // - - Iframe1 http://framed.test.liveintent.com:3001/framed
  // - - - Iframe2 http://bln.test.liveintent.com:3001/page
  it('should send the referrer and the page url when the tracker is in the nested iframe and the request is cross-domain', function () {
    const supportsLS = probeLS()
