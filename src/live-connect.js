...
import * as errorHandler from './handlers/error-pixel'
 ...
 * @constructor
 */
export function LiveConnect (liveConnectConfig) {
  let configuration = {}
  try {
  ...
  try {
    const reducer = (accumulator, func) => accumulator.combineWith(func(accumulator.data))
